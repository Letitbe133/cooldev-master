<div class="row">
	<div class="col s12 m5 offset-m1">
	  <div class="card ">
	    <div class="card-image waves-effect waves-block waves-light">
	      <img class="activator" src="assets/img/mi-v3.png">
	    </div>
	    <div class="card-content">
	      <span class="card-title activator grey-text text-darken-4"><h2 >Mylène</h2>
					<h5>Chargée de projets web</h5>
					<p>CEO/CXO & Co-founder</p><i class="material-icons right">more_vert</i></span>
	      <p><a href="#"><img src="assets/img/facebook.png" alt=""></a>
	      <a href="#"><img src="assets/img/twitter.png" alt=""></a></p>
	    </div>
	...
	<div class="col s12 m5">
	  <div class="card">
	    <div class="card-image waves-effect waves-block waves-light">
	      <img class="activator" src="assets/img/lio-v3.png">
	    </div>
	    <div class="card-content">
	      <span class="card-title activator grey-text text-darken-4"><h2 >Lionel</h2>
					<h5>Développeur web</h5>
					<p>CTO & Co-founder</p><i class="material-icons right">more_vert</i></span>
	      <p><a href="#"><img src="assets/img/facebook.png" alt=""></a>
	      <a href="#"><img src="assets/img/twitter.png" alt=""></a></p>
	    </div>
	    <div class="card-reveal">
